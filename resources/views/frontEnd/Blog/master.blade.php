            ...
            <div class="container">
                <div class="navbar-header">
					...
					<h1 class="navbar-brand">
						<a href="{{url('/')}}">
						<img src="{{ asset('public/Admin/')}}/images/logo.png" height="40" width="164" alt="">
						</a>
					</h1>
					<!-- /logo -->
                </div>
					...
					<div class="col-md-8 col-md-offset-0 col-sm-10 col-sm-offset-1">
						...
						@foreach($posts as $post)
							<div class="col-md-6 col-sm-6">
								<img class="img-responsive" src="{{asset($post->image)}}" width="150px" height="150px" alt="">
							</div>
						@endforeach	
						</div>
						<div class="block">
						@foreach($posts as $post)
							<span class="first-child-span">{{$post->ptitle}}</span>
						<p class="first-child">
							{{$post->pcontent}}
						</p>	
